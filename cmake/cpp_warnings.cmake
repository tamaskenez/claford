###############################################################################
# Modified from https://github.com/joseasoler/cmake_cpp_warnings
#               at 5f7a767432419c86f6e8620b5f8db229ec47e490
#
# The following local changes have been made on the joseasoler version:
#
# -Wno-sign-conversion            # Implicit conversions between signed and unsigned integers.
#     Rationale: size_t and integers are mixed quite often. It's safer to use integer and
#                mix them (and disable this warning) than to use unsigned everywhere and enabled
#                this warning.
#
# -Wno-implicit-float-conversion
#     Rationale: in this application double -> float conversions are not critical.
#
# -Wdouble-promotion              # Warn about implicit conversions from "float" to "double".
#     Rationale: float -> double conversions have no risk.
#
# -Wno-sign-compare
#     Rationale: comparing integers of different signs is risky, error-prone. The warning should be
#                enabled. For now it's disabled because of the many callsites needed to be fixed.
#
# -Wno-switch-enum
#     Rationale: The warning prevents using `default` with enums, forcing to list each element which
#                is quite cumbersome for enums containing many cases.
#
# -Wnon-virtual-dtor              # X has virtual functions but non-virtual destructor
#     Rationale: it's a design idiom to write an interface class with non-virtual but protected destructor
#
###############################################################################
